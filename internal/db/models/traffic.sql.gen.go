...
func (q *Queries) BusiestDevices(ctx context.Context, arg BusiestDevicesParams) ([]*BusiestDevicesRow, error) {
	rows, err := q.query(ctx, q.busiestDevicesStmt, busiestDevices, arg.Hour, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) FirstContacts(ctx context.Context, arg FirstContactsParams) ([]*FirstContactsRow, error) {
	rows, err := q.query(ctx, q.firstContactsStmt, firstContacts, arg.Since, arg.LimitRows)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) TopOrganisations(ctx context.Context, arg TopOrganisationsParams) ([]*TopOrganisationsRow, error) {
	rows, err := q.query(ctx, q.topOrganisationsStmt, topOrganisations, arg.Hour, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
