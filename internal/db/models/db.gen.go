...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.lastSuccessfulDeviceScanTimestampStmt, err = db.PrepareContext(ctx, lastSuccessfulDeviceScanTimestamp); err != nil {
		return nil, fmt.Errorf("error preparing query LastSuccessfulDeviceScanTimestamp: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.lastSuccessfulDeviceScanTimestampStmt != nil {
		if cerr := q.lastSuccessfulDeviceScanTimestampStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing lastSuccessfulDeviceScanTimestampStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	lastSuccessfulDeviceScanTimestampStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		lastSuccessfulDeviceScanTimestampStmt: q.lastSuccessfulDeviceScanTimestampStmt,
