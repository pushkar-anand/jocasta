...
// and a randomised address is generated by the device, so it matches no
...
type Vendor struct {
	...
	// Bits is the width of the prefix that matched: 24, 28, or 36. A longer
	// prefix is a more specific assignment and identifies a smaller vendor
	// that bought part of a block from its registrant.
	Bits int
}
...
// which is what the second-least-significant bit of the first octet means. A
// manufacturer's address has the bit clear.
//
